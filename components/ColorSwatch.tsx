      ...
      <div className="flex items-center gap-2 overflow-x-auto pb-2">
        {visibleColors.map((color, index) => (
          ...
          >
            ...
            <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-2 py-1 bg-[var(--ink)] text-white text-xs rounded whitespace-nowrap z-10 pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity">
              {color.name}
